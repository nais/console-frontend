	...
	},
	{
		...
		statuses: [
			...
			},
			{
				...
				deploymentID: '7b11deef-a31d-4783-a314-17923d6f4d4b',
				status: 'in_progress',
				message: 'AzureAdApplication/pensjon-pselv-q0 (AddedFinalizer): Object finalizer is added',
	...
	},
	{
		...
		statuses: [
			...
			},
			{
				...
				deploymentID: '0bf35050-cecc-4f99-b99f-fbe372240650',
				status: 'in_progress',
				message: 'Application/spinntektsmelding-frontend (RolloutComplete): Rollout has completed',
			...
			},
			{
				...
				deploymentID: '0bf35050-cecc-4f99-b99f-fbe372240650',
				status: 'in_progress',
				message: 'Deployment/spinntektsmelding-frontend (Injected): Linkerd sidecar proxy injected',
	...
	},
	{
		...
		statuses: [
			...
			},
			{
				...
				deploymentID: 'd54302f9-629a-416c-aa53-ccd566901644',
				status: 'in_progress',
				message: 'Pod/syfomodiaperson-59df47c4d6-ttrf9 (Started): Started container linkerd-proxy',
			...
			},
			{
				...
				deploymentID: 'd54302f9-629a-416c-aa53-ccd566901644',
				status: 'in_progress',
				message: 'Pod/syfomodiaperson-59df47c4d6-ttrf9 (Created): Created container linkerd-proxy',
			...
			},
			{
				...
				deploymentID: 'd54302f9-629a-416c-aa53-ccd566901644',
				status: 'in_progress',
				message: 'Pod/syfomodiaperson-689d7c7bfd-8287c (Killing): Stopping container linkerd-proxy',
			...
			},
			{
				...
				deploymentID: 'd54302f9-629a-416c-aa53-ccd566901644',
				status: 'in_progress',
				message: 'Pod/syfomodiaperson-59df47c4d6-kvz2x (Started): Started container linkerd-proxy',
			...
			},
			{
				...
				deploymentID: 'd54302f9-629a-416c-aa53-ccd566901644',
				status: 'in_progress',
				message: 'Pod/syfomodiaperson-59df47c4d6-kvz2x (Created): Created container linkerd-proxy',
	...
	},
	{
		...
		statuses: [
			...
			},
			{
				...
				deploymentID: '6d29cf58-e815-4dc5-81d8-175746b5089b',
				status: 'in_progress',
				message: 'Pod/skjemautfylling-58c757ddd8-8h4zg (Killing): Stopping container linkerd-proxy',
			...
			},
			{
				...
				deploymentID: '6d29cf58-e815-4dc5-81d8-175746b5089b',
				status: 'in_progress',
				message: 'Pod/skjemautfylling-58c757ddd8-7h8lg (Killing): Stopping container linkerd-proxy',
	...
	},
	{
		...
		statuses: [
			...
			},
			{
				...
				deploymentID: '94250c60-2aeb-451b-b880-3369d9508abf',
				status: 'in_progress',
				message: 'Pod/pensjon-pen-q0-7bb6474c45-5t8nc (Killing): Stopping container pensjon-pen-q0',
			...
			},
			{
				...
				deploymentID: '94250c60-2aeb-451b-b880-3369d9508abf',
				status: 'in_progress',
				message: 'Pod/pensjon-pen-q0-57998475fc-8p8k2 (Started): Started container pensjon-pen-q0',
			...
			},
			{
				...
				deploymentID: '94250c60-2aeb-451b-b880-3369d9508abf',
				status: 'in_progress',
				message: 'Pod/pensjon-pen-q0-57998475fc-8p8k2 (Created): Created container pensjon-pen-q0',
			...
			},
			{
				...
				deploymentID: '94250c60-2aeb-451b-b880-3369d9508abf',
				status: 'in_progress',
				message: 'Pod/pensjon-pen-q0-7bb6474c45-whhh7 (Killing): Stopping container pensjon-pen-q0',
			...
			},
			{
				...
				deploymentID: '94250c60-2aeb-451b-b880-3369d9508abf',
				status: 'in_progress',
				message: 'Pod/pensjon-pen-q0-57998475fc-npht8 (Started): Started container pensjon-pen-q0',
			...
			},
			{
				...
				deploymentID: '94250c60-2aeb-451b-b880-3369d9508abf',
				status: 'in_progress',
				message: 'Pod/pensjon-pen-q0-57998475fc-npht8 (Created): Created container pensjon-pen-q0',
	...
	},
	{
		...
		statuses: [
			...
			},
			{
				...
				deploymentID: 'a70b17f2-9238-49d5-9c7e-402f5105a313',
				status: 'in_progress',
				message: 'IDPortenClient/tiltak-refusjon-arbeidsgiver (Synchronized): Client is up-to-date',
