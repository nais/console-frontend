<script lang="ts">
	...
	import { AuditResourceType, type AuditResourceType$options } from '$houdini';
	...
	<Card columns={12}>
		...
		{#if $AuditEvents.data}
			...
			{:else}
				<p>No events</p>
			{/each}
			{#if ae.team.auditEntries.pageInfo.hasPreviousPage || ae.team.auditEntries.pageInfo.hasNextPage}
