...
/**
 * Query loaded by the OpenSearch create page (`+page.ts`). Returns the
 ...
 */
export const CreateOpenSearchEnvironmentsQuery = gql(/* GraphQL */ `
	query CreateOpenSearchEnvironments($slug: Slug!) {
		team(slug: $slug) {
			environments {
				gcpProjectID
				environment {
