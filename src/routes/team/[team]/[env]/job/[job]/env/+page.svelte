<script lang="ts">
	...
	const backHref = $derived(`/team/${page.params.team}/${page.params.env}/job/${page.params.job}`);
</script>
...
<div class="page">
	...
	<Alert variant="warning" size="small">
		These changes are temporary and will be overwritten on next deploy. The job is restarted to
		apply them.
	</Alert>
