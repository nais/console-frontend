...
{:else if secret}
	...
	>
		{#snippet header()}
			<Heading as="h2" size="large">Delete Secret</Heading>
		{/snippet}
		<p>
	...
	>
		{#snippet header()}
			<Heading as="h2" size="large">Delete Key From Secret</Heading>
		{/snippet}
		<p>
	...
	<div class="wrapper">
		<div class="content">
			...
			<div class="table-scroll" tabindex="0" role="region" aria-label="Secret key-value pairs">
